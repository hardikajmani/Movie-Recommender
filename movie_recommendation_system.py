...
Original file is located at
    https://colab.research.google.com/drive/1BNJcbJNrRxRnlwrBODXwQUwVqmj0h1Kr
"""
...
smd['cast'] = smd['cast'].apply(lambda x: x[:3] if len(x) >= 3 else )
...
def imporved_recommendations(title):
  idx = indices[title]
  sim_scores = list(enumerate(cosine_sim[idx]))
  sim_scores = soreted(sim_scores, key = lambda x: x[1], reverse = True)
  sim_scores = sime_scores[1 : 26]
  movie_indices = [i[0] for i in sim_scores]
